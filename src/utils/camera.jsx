    ...
    try {
      ...
      if (error.name === 'NotReadableError') {
        Swal.fire({
          ...
          text: 'Kamera sedang digunakan oleh aplikasi lain. Tutup aplikasi tersebut dan coba lagi.',
        ...
        Swal.fire({
          ...
          text: 'Berikan izin akses kamera pada browser Anda.',
          confirmButtonText: 'OK',
        });
        ...
        Swal.fire({
          ...
          text: 'Kamera yang dipilih tidak tersedia. Pilih kamera lain.',
          confirmButtonText: 'OK',
        });
      } else {
        Swal.fire({
          ...
          text: 'Terjadi kesalahan saat membuka kamera. Silakan coba lagi.',
          confirmButtonText: 'OK',
        });
      }

      return null; // Return null if the stream cannot be initialized
    }
  }
